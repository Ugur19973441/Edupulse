  ...
  return (
    <div className="space-y-4">
      ...
      <form className="max-w-lg space-y-3">
        <div><label className="block text-sm">Ad Soyad</label><input defaultValue="Veli" className="border rounded px-2 py-1 w-full"/></div>
        <div><label className="block text-sm">E-posta</label><input defaultValue="veli@demo.com" className="border rounded px-2 py-1 w-full"/></div>
